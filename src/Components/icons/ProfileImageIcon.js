...
function ProfileImageIcon({
  ...
  return (
    ...
    >
      <img
        style={{ objectFit: "contain", ...styles.conatinerImage }}
        src={profileImageUrl}
        alt="Profile Image"
      />
    </div>
